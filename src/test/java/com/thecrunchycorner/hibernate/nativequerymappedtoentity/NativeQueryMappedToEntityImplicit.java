...
@SpringBootTest
public class NativeQueryMappedToEntityImplicit {
    ...
    public void process() {
        ...
        Query query = em.createNativeQuery(
                "SELECT * FROM Account15Implicit a WHERE id = 3",
                Account15Implicit.class
        );


        Account15Implicit actualAc = (Account15Implicit) query.getSingleResult();
